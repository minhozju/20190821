<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditStudent.aspx.cs" Inherits="StudbManage.EditStudent" %>
 ...
 <tr style="height: 35px;">
    ...
    <Columns>
      ...
      <asp:BoundField DataField="birthday" HeaderText="生日" SortExpression="birthday" />
        <asp:TemplateField HeaderText="专业" SortExpression="dept">
              <EditItemTemplate>
          <asp:DropDownList ID="ddlDept" runat="server" Width="70px" Height="20px" SelectedValue='<%# Bind("dept") %>'>
  ...
  <asp:SqlDataSource ID="SqlDataSource1" runat="server"
    ...
    DeleteCommand="DELETE FROM [student] WHERE [sno] = @sno and not exists(select * from [student_course] where [sno] = @sno )"
    SelectCommand="SELECT * FROM [student]"
    UpdateCommand="UPDATE [student] SET [sname] = @sname,[sex] = @sex, [birthday] = @birthday, [dept] = @dept, [spno]=@spno,[classno] = @classno WHERE [sno] = @sno" InsertCommand="INSERT INTO [student] ([sno], [sname], [sex], [birthday], [dept],  [classno], [password], [role]) VALUES (@sno, @sname, @sex, @birthday, @dept, @classno)">
  </asp:SqlDataSource>
</asp:Content>
